...
<a href="https://drive.google.com/file/d/1IILKykWhf6Ob8InMG-kns_kveMLQUNeC/view?usp=sharing" target="_blank">CV</a>
...
Abstract: I study how firm-level financial frictions and work effort affect labor market fluctuations in a dynamic general equilibrium model with standard DMP-type labor market frictions. Firms are subject to investment adjustment costs and limited enforcement constraints while workers are allowed to endogenize their labor effort through bargaining protocols. Wages are sticky for existing workers but flexible for new hires. The initial response of effort exhibits a procyclical pattern in the flexible wage setting while being countercyclical in the sticky wage setting. The appearance of financial frictions and effort bargaining, when taken separately, lead to more sluggish impulse responses and persistent deviations of labor market variables. However, when the two forces are combined together, I find that effort bargaining dampens the amplification effect of financial frictions on long-run labor market volatility.
